...
import { Instagram, Linkedin, Youtube, ShieldCheck, Facebook, MessageCircle } from 'lucide-react'
    ...
    return (
        <footer className="w-full bg-[#F7FBFC] text-zinc-600 border-t border-zinc-200">
            ...
            <div className="container mx-auto px-6 py-16 md:py-20">
                <div className="flex flex-col items-center text-center mb-16 border-b border-zinc-200 pb-16">
